...
import { Address, BankAccount, Group, LegalIdentifier, PriceList } from './Tabs';
        ...
        <div className='h-screen !overflow-y-scroll no-scrollbar'>
            <div className='p-8 w-full'>
                <div className='flex justify-between  my-6'>
                    <h1 className='text-xl font-bold text-secondary-grey'>{id === 'new' ? 'Create' : 'Edit '} New Vendor</h1>
                ...
                <Grid container className='mt-4 w-full' justifyContent='space-between'>
                    <Grid item xs={5.5}>
                        <Box sx={{ textAlign: 'left', margin: '8px 10px' }}>
                            <p className='font-bold text-secondary-grey'>Vendor Code</p>
                            <TextField
                                variant='outlined'
                                size='normal'
                                InputProps={{
                        ...
                        <Box sx={{ textAlign: 'left', margin: '8px 10px' }}>
                            <p className='font-bold text-secondary-grey'>Terms</p>
                            <TextField
                                variant='outlined'
                                size='normal'
                                InputProps={{
                        ...
                        <Box sx={{ textAlign: 'left', margin: '8px 10px' }}>
                            <p className='font-bold text-secondary-grey'>Legal Identifier</p>
                            <TextField
                                variant='outlined'
                                size='normal'
                                InputProps={{
                        ...
                        <Box sx={{ textAlign: 'left', margin: '8px 10px' }}>
                            <p className='font-bold text-secondary-grey'>Group</p>
                            <TextField
                                variant='outlined'
                                size='normal'
                                InputProps={{
                        ...
                        <Box sx={{ textAlign: 'left', margin: '8px 10px' }}>
                            <p className='font-bold text-secondary-grey'>Bank Account</p>
                            <TextField
                                variant='outlined'
                                size='normal'
                                InputProps={{
                    ...
                    <Grid item xs={5.5}>
                        <Box sx={{ textAlign: 'left', margin: '8px 10px' }}>
                            <p className='font-bold text-secondary-grey'>Address 1</p>
                            <TextField
                                variant='outlined'
                                size='normal'
                                InputProps={{
                        ...
                        <Box sx={{ textAlign: 'left', margin: '8px 10px' }}>
                            <p className='font-bold text-secondary-grey'>Address 2</p>
                            <TextField
                                variant='outlined'
                                size='normal'
                                InputProps={{
