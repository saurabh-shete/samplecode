        ...
        <Paper className='p-4'>
            <form ref={formRef}>
                <Stack direction='column' rowGap={2}>
                    <SimpleSelect name='soNumber' label='SO Number' options={soNumbers} />
                    <p className='text-sm text-secondary-grey'>PO Number: PO1200</p>
                    <p className='text-sm text-secondary-grey'>PO Date: 23/02/2023</p>
                    <SimpleSelect name='typeOfLc' label='Type of LC (40 A)' options={typeOfLc} />
                    <SimpleSelect name='subTypeOfLc' label='Subtype of LC' options={subtypeOfLc} />
                </Stack>
            </form>
        </Paper>
    );
