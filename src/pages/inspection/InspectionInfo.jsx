...
import InspectionTopSection from './InspectionTopSection';
    ...
    return (
        <Box className='p-8 w-full text-left h-screen !overflow-y-scroll no-scrollbar'>
            <div className='flex justify-between'>
                <h1 className='text-xl font-bold text-secondary-grey'>{id === 'new' ? 'CREATE ' : 'EDIT '} Inspection</h1>
                <h1 className='text-secondary-grey text-lg'>Imports / Inspection</h1>
            </div>
