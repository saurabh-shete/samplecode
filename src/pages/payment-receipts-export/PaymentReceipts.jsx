    ...
    return (
        <Box className='p-8 w-full text-left h-screen !overflow-y-scroll no-scrollbar'>
            <div className='flex justify-between'>
                <h1 className='text-xl font-bold text-secondary-grey'>{isAdvance ? 'ADVANCE RECEIPTS' : 'PAYMENT AGAINST INVOICES'}</h1>
                <h1 className='text-secondary-grey text-lg'>Exports / {isAdvance ? 'Advance' : 'Payment Received'}</h1>
            </div>
            ...
            {!isAdvance && (
                <div className='flex flex-row justify-end'>
                    <div className='mt-4 bg-indigo-100 grid grid-cols-4 justify-end grid-rows-4 gap-4 gap-y-2 auto-cols-auto w-fit p-4 w-fit rounded-lg'>
                        <p className='text-xl font-bold text-primary-blue col-span-2'>Amount Received</p>
                        ...
                        <p className='text-xl font-bold text-primary-blue col-span-2'>Amount Settled</p>
                        <p className='text-lg font-bold text-secondary-grey col-span-1'>USD</p>
                        <p className='text-lg font-bold text-secondary-grey col-span-1'>12,000</p>
    ...
    return (
        <>
            ...
            <div className='grid grid-cols-2 gap-x-4'>
                ...
                <div className='grid grid-cols-6 gap-x-4 items-center'>
                    <p className='font-bold text-primary-grey col-span-2'>Receiving Bank Charges</p>
                    <div className='text-secondary-grey col-span-4'>
